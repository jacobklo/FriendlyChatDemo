...
FriendlyChat.prototype.signIn = function() {
  // (DEVELOPER): Sign in Firebase with credential from the Google user.
...
FriendlyChat.prototype.signOut = function() {
  // (DEVELOPER): Sign out of Firebase.
  this.auth.signOut();
};
...
FriendlyChat.prototype.checkSignedInWithMessage = function() {
  /* (DEVELOPER): Check if user is signed-in Firebase. */
...
FriendlyChat.prototype.saveMessagingDeviceToken = function() {
  // (DEVELOPER): Save the device token in the realtime datastore
...
FriendlyChat.prototype.requestNotificationsPermissions = function() {
  // (DEVELOPER): Request permissions to send notifications.
